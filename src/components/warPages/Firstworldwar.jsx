...
import img from "../images/firstworldwar.png";

const Firstworldwar = () => {
  return (
    <div className="fulltext">
      <h1>პირველი მსოფლიო ომი</h1>
      <img src={img} alt="" />
      <p>
      პირველი მსოფლიო ომი: მიზეზები და შედეგები <br /><br />

პირველი მსოფლიო ომი, რომელიც 1914-1918 წლებში მიმდინარეობდა, ერთ-ერთი ყველაზე დიდი და დრამატული კონფლიქტი იყო მსოფლიო ისტორიაში. ამ ომმა მოიცვა მრავალი ქვეყანა და მილიონობით ადამიანის სიცოცხლე იმსხვერპლა. ომი დაიწყო ევროპის ქვეყნებს შორის დაძაბულობის შედეგად, რომელიც გაღრმავდა ეკონომიკური, პოლიტიკური და სამხედრო ფაქტორების გამო. ეს კონფლიქტი მსოფლიო ომად იქცა, რადგან მასში ჩაერთო მრავალი ქვეყანა და რამდენიმე კონტინენტი. <br /><br />
